...
/*    @FXML
    public void buttonShow(ActionEvent actionEvent) {
        ...
        for(int i = 0; i < tableview.getItems().size(); i++ ) {
            ingredient = tableview.getItems().get(i);
            arrList.add(new ArrayList<>());
            arrList.get(i).add(ingredient.getIngredientName());
            arrList.get(i).add(ingredient.getIngredientAmount());
        }
        ...
        ingredientlist = tableview.getSelectionModel().getSelectedItems();

        System.out.print(ingredientlist.get(0).getIngredientName());
        System.out.print(" ");
        System.out.print(ingredientlist.get(0).getIngredientAmount());
    }*/
